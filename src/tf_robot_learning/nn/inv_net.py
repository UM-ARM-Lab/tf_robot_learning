...
def dense_resnet(inputs, mid_channels, output_channels, num_blocks, activation=None, scale=1.):
    ...
    inputs = tf.layers.dense(inputs, mid_channels, activation=activation, name='initial',
    ...
    with tf.variable_scope(name) as scope:
        ...
        if backward:
            ...
            with tf.variable_scope('st1'):
                ...
                rescale1 = tf.get_variable('rescale_s', shape=[inputs.get_shape().as_list()[1]], dtype=tf.float32,
            ...
            with tf.variable_scope('st2'):
                ...
                rescale2 = tf.get_variable('rescale_s', shape=[inputs.get_shape().as_list()[1]], dtype=tf.float32,
                                           initializer=tf.constant_initializer(1.))
